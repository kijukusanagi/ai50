...
# I need to implement the shortest_path function
# I need to implement the person_id_for_name function
...
def shortest_path(source, target):
    ...
    # Create a Node class for actors
    ...
    # Create a Frontier class for BFS
    ...
    class QueueFrontier():
      ...
      # Check if frontier contains a certain state
    ...
    # Create a function to get neighbors for a person (actor)
    def neighbors_for_person(person_id):
      # Return the set of movies and actors for the person (actor) with the given ID
    ...
    while True:
      ...
      for action, state in neighbors_for_person(curr_node.state):
        ...
        if not frontier.contains_state(state) and state not in explored:
          ...
          print('Adding', new_node.state, 'to frontier!')
